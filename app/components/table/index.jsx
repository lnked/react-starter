      ...
      if (thead) {
        ...
        Object.keys(thead).map((id) => {
          ...
          Object.keys(thead[id]).map((key) => {
            ...
            row.push(<th className={css.tcol} key={`thead_col_${key}`}>
              <span className={sorterClass.join(' ')}>{thead[id][key]}</span>
                     </th>)
          })

          list.push(<tr className={css.row} key={`thead_${id}`}>
      ...
      if (tbody) {
        ...
        Object.keys(tbody).map((id) => {
          ...
          Object.keys(tbody[id]).map((key) => {
            row.push(<td className={css.col} key={`tbody_col_${key}`}>
              {tbody[id][key]}
                     </td>)
          })
      ...
      if (tfoot) {
        ...
        Object.keys(tfoot).map((id) => {
          ...
          Object.keys(tfoot[id]).map((key) => {
            row.push(<td className={css.fcol} key={`tfoot_col_${key}`}>
              {tfoot[id][key]}
                     </td>)
          })

          list.push(<tr className={css.row} key={`tfoot_${id}`}>
